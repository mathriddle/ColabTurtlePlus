...
<circle stroke="{turtle_color}" stroke-width="3" fill="transparent" r="{rad}" cx="0" cy="0" />
<polygon points="0,19 3,16 -3,16" style="fill:{turtle_color};stroke:{turtle_color};stroke-width:{pen_width}" />
</g>"""
