...
SVG_TEMPLATE = """
    ...
    """
TURTLE_TURTLE_SVG_TEMPLATE = """<g id="turtle" visibility="{visibility}" transform="matrix(2,0,{-turtle_x},0,2,{-turtle_y}) rotate({degrees},{rotation_x},{rotation_y}) translate({turtle_x}, {turtle_y})">
