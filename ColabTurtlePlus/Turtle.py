...
VALID_TURTLE_SHAPES = {'turtle', 'ring', 'classic', 'arrow', 'square', 'triangle', 'circle', 'turtle2', 'blank', 'user', 'image'}
...
<image href="maincomponent.png" height="50" width="50" transform="skewX({sk}) scale({sx},{sy})"  />
</g>"""
