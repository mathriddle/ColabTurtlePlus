...
Added additional shapes from classic turtle.py: 'classic' (the default shape), 'arrow', 'square', 'triangle', 'circle'
...
<polygon points="-10,0 -9.51,-3.09 -8.09,-5.88 -5.88,-8.09 -3.09,-9.51 0,-10 3.09,-9.51 5.88,-8.09 8.09,-5.88 9.51,-3.09 10,0 9.51,3.09 8.09,5.88 5.88,8.09 3.09,9.51 0.00,10.00 -3.09,9.51 -5.88,8.09 -8.09,5.88 -9.51,3.09" transform="scale({sx},{sy})" style="stroke:none;fill:{turtle_color};fill-opacity:1;" />
</g>"""
